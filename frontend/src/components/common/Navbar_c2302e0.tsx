                                                        ...
                                                        >
                                                            ...
                                                            <div className="ml-4 flex-1 overflow-hidden">
                                                                ...
                                                                <div className="flex items-center mt-1 space-x-3">
                                                                    <p className="text-sm font-medium text-slate-900 dark:text-slate-300">Γé╣{product.price}</p>
                                                            ...
                                                            {suggestions.map((product) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="ml-3 overflow-hidden">
                                                                        ...
                                                                        <p className="text-[10px] text-primary-600 font-medium">Γé╣{product.price}</p>
                                                                    </div>
                                                                </button>
                                                            ))}
                                                            <button
